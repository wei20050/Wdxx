...
namespace Wdxx.Core
{
    ...
    /// 本地服务挂接类
    /// </summary>
    public class CoreHttpHost : ServiceHost
    {
        ...
        public CoreHttpHost(Type t) : this(t, t, GetUri()) { }
        ...
        /// <param name="t">要挂服务的类</param>
        public CoreHttpHost(Type it,Type t) : this(it, t, GetUri()) { }
        ...
        public CoreHttpHost(Type t, string uri) : this(t, t, uri) { }
        ...
        /// <param name="t">要挂服务的类</param>
        /// <param name="uri">服务基地址</param>
        public CoreHttpHost(Type it, Type t, string uri) : base(t, new Uri(uri))
        {
            //保存基地址
            _uri = uri.TrimEnd('/') + "/";
            //默认超时时间分钟数
